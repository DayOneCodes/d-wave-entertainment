...
<section className="py-20 px-4 md:px-10 lg:px-40 bg-white dark:bg-[#150c1a] border-t border-slate-200 dark:border-white/5">
...
<p className="mt-4 text-xs text-slate-500 dark:text-gray-500">We respect your privacy. Unsubscribe at any time.</p>
</div>
</section>
    </>
  )
