import theExperience from "../assets/the-experience.webp";
import theTalent from "../assets/the-talent.webp";

function MissionSection  () {
  return (
    <section className="bg-card-dark relative overflow-hidden">
...
<h2 className="text-primary tracking-light text-[32px] font-bold leading-tight md:text-4xl lg:text-5xl max-w-[720px]">
                                    Two Worlds, <span className="text-transparent bg-clip-text bg-primary">One Vision</span>
</h2>
<p className="text-primary text-lg font-normal leading-relaxed max-w-[720px]">
