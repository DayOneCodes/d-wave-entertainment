  ...
  return (
    <>
      <section className="py-24 px-4 md:px-10 lg:px-40 bg-white" id="services" ref={ref} >
          ...
          <div className="flex gap-4 p-4 rounded-xl bg-background-light  border border-gray-100  hover:border-primary/50 transition-colors">
          <div className="size-12 rounded-full bg-primary/20 flex items-center justify-center text-primary shrink-0">
          <span className="material-symbols-outlined">trending_up</span>
          </div>
          <div>
          <h3 className="text-xl font-bold text-slate-900  mb-1">Career Development</h3>
          <p className="text-slate-500  text-sm">Strategic planning for long-term growth and sustainable success in the industry.</p>
          </div>
          </div>
          <div className="flex gap-4 p-4 rounded-xl bg-background-light border border-gray-100 hover:border-primary/50 transition-colors">
          <div className="size-12 rounded-full bg-primary/20 flex items-center justify-center text-primary shrink-0">
          ...
          <div>
          <h3 className="text-xl font-bold text-slate-900  mb-1">Global Booking</h3>
          <p className="text-slate-500  text-sm">Connecting our roster with premier venues and festivals worldwide.</p>
          </div>
          </div>
          <div className="flex gap-4 p-4 rounded-xl bg-background-light border border-gray-100 hover:border-primary/50 transition-colors">
          <div className="size-12 rounded-full bg-primary/20 flex items-center justify-center text-primary shrink-0">
          ...
          <div>
          <h3 className="text-xl font-bold text-slate-900 mb-1">Brand Promotion</h3>
          <p className="text-slate-500 text-sm">Building recognizable personal brands through targeted marketing campaigns.</p>
          </div>
          </div>
          </div>
          </div>
