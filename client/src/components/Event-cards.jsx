      ...
      <div className="group bg-white rounded-xl overflow-hidden shadow-lg hover:shadow-2xl transition-all duration-300 border border-gray-100" onClick={
        () => {window.open(`https://${ticketUrl}`, '_blank')}
          ...
          <div className="p-6">
              ...
              <button className="w-full py-3 rounded-lg border border-slate-200 text-slate-900 font-bold hover:bg-primary hover:text-white hover:border-primary transition-colors flex justify-center items-center gap-2">
                  Get Tickets
              </button>
          </div>
      </div>
