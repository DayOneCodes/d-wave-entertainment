function FAQSection () {
  return (
    <>
      <div className="w-full bg-[#130b16] py-20 px-4 md:px-10 lg:px-40 border-t border-[#332839]">
...
<p className="text-[#b09cba]">Common questions about bookings and events.</p>
</div>
<div className="flex flex-col gap-4">
<details className="group bg-[#231b27] rounded-lg border border-[#4c3b54] open:border-primary/50 transition-colors">
<summary className="flex cursor-pointer items-center justify-between p-6 list-none text-white font-medium text-lg">
<span>How far in advance should I book an artist?</span>
<span className="transition group-open:rotate-180">
<span className="material-symbols-outlined">keyboard_arrow_down</span>
</span>
</summary>
<div className="px-6 pb-6 text-[#b09cba] leading-relaxed">
