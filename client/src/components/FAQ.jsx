function FAQSection () {
  return (
    <>
      <div className="w-full bg-background-light py-20 px-4 md:px-10 lg:px-40 border-t border-[#332839]">
<div className="max-w-[800px] mx-auto flex flex-col gap-10">
<div className="text-center flex flex-col gap-2">
<h2 className="text-primary text-3xl font-bold">Frequently Asked Questions</h2>
<p className="text-[#6a5f64]">Common questions about bookings and events.</p>
</div>
<div className="flex flex-col gap-4">
<details className="group bg-primary/10 rounded-lg border border-[#4c3b54] open:border-primary/50 transition-colors">
<summary className="flex cursor-pointer items-center justify-between p-6 list-none text-primary font-medium text-lg">
<span>How far in advance should I book an artist?</span>
<span className="transition group-open:rotate-180">
<span className="material-symbols-outlined">keyboard_arrow_down</span>
</span>
</summary>
<div className="px-6 pb-6 text-[#6a5f64] leading-relaxed">
